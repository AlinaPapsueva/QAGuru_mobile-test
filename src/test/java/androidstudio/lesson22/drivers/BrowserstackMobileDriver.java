package androidstudio.lesson22.drivers;
...
public class BrowserstackMobileDriver implements WebDriverProvider {
    ...
    public static AndroidBrowserstackConfig config =
            ConfigFactory.create(AndroidBrowserstackConfig.class, System.getProperties());
